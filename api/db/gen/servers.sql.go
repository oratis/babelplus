...
const addNodeTrafficBatch = `-- name: AddNodeTrafficBatch :one
...
type AddNodeTrafficBatchParams struct {
...
type AddNodeTrafficBatchRow struct {
...
func (q *Queries) AddNodeTrafficBatch(ctx context.Context, arg AddNodeTrafficBatchParams) (AddNodeTrafficBatchRow, error) {
	row := q.db.QueryRow(ctx, addNodeTrafficBatch,
		arg.UserIds,
		arg.UpBytes,
		arg.DownBytes,
		arg.ServerID,
	)
	var i AddNodeTrafficBatchRow
	err := row.Scan(&i.UpdatedUsers, &i.BumpedServers)
	return i, err
}
