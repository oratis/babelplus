...
> 🔴 **2026-08-17 补充：代价比本节原先写的更大。**
>
> 已用 Google Cloud Billing Catalog API 取得权威价目
> （证据见 [evidence/gcp-egress-pricing-20260817](../evidence/gcp-egress-pricing-20260817/)），
> 两个层级的**计价模型根本不同**，而本节此前只比了单价：
>
> | | Standard | Premium |
> |---|---|---|
> | 计价维度 | 只按源区域，**与目的地无关** | 按「源区域→目的地」配对 |
> | 香港出口单价 | **$0.11/GiB** | **$0.23/GiB** |
> | 免费额度 | **每源区域每月前 200 GiB $0** | **无** |
>
> 且 **中国是香港出口在 Premium 下最贵的目的地**（$0.23，欧洲仅 $0.12，贵 1.92 倍）。
>
> 按每用户 100 GB/月折算的真实差距：
>
> | 规模 | Standard | Premium |
> |---|---|---|
> | 1 用户 | **$0**（免费额度内） | **$23.00** |
> | 10 用户 | $8.80/人 | $23.00/人 |
> | 50 用户 | $10.56/人 | $23.00/人 |
>
> **也就是说：本裁决在小规模下的代价是「$0 vs $23/人/月」，不是原先以为的「贵一倍」。**
> 而它唯一的理由（IPv6 支持）建立在一条**待核实**的社区观察上。
> **这使本条从「论据最弱」升级为「本项目最应当优先用实测推翻的决定」。**
